...
import { MessageSquare, Info, ShieldCheck, CornerDownRight, Tag } from "lucide-react";
    ...
    <div className="project-popup premium-popup animate-slide-up" style={{ padding: '0.875rem' }}>
      ...
      <footer className="popup-actions" style={{ display: 'flex', gap: '0.5rem', borderTop: '1px solid var(--border-subtle)', paddingTop: '0.625rem' }}>
        ...
        >
          ...
          {showForm ? "Close Form" : "Submit Public Comment"}
        </button>
      </footer>

      {showForm && (
        <div className="comment-form-panel animate-slide-up" style={{ marginTop: '0.875rem' }}>
          <CommentForm
